/*!
 * upload.js v0.0.1
 * https://github.com/GetOlympus/Hera-Renderer
 *
 * This plugin makes the WordPress medialib popin usable in all backoffice pages.
 *
 * Example of JS:
 *      $('.upload').heraUpload({
 *          // Options usefull for the plugin
 ...
 *          delbutton: '.del-media',                    // delete media css selector button
